    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <?php if ($isLoggedIn): ?>
          ...
          <li class="nav-item"><a class="nav-link" href="customer_dashboard_page.php">Dashboard</a></li>
          <li class="nav-item"><a class="nav-link" href="review.php">Write a Review</a></li>
