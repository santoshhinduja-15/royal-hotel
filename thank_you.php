...
<head>
  <meta charset="UTF-8" />
  <title>Booking Successful - Royal Hotel</title>
        ...
        <div class="col-md-8 col-lg-6">
          <div class="card shadow border-0 p-4">
            <div class="card-body">
              ...
              <p class="lead text-muted mb-4">Thank you for booking with <strong>Royal Hotel</strong>. We look forward to hosting you.</p>
